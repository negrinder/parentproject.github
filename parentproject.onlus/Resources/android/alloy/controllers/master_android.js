function Controller() {
    ...
    $.__views.master_android.add($.__views.__alloyId4);
    var __alloyId5 = [];
    ...
    $.__views.__alloyId4.add($.__views.immagini);
    ...
    $.__views.__alloyId4.add($.__views.bordoTop);
    ...
    $.__views.__alloyId4.add($.__views.bordoBottom);
    $.__views.notizieContainer = Ti.UI.createView({
        top: 292,
        backgroundColor: "#fff",
        id: "notizieContainer"
    });
    $.__views.__alloyId4.add($.__views.notizieContainer);
    ...
    $.__views.__alloyId4.add($.__views.chisiamoContainer);
    ...
    $.__views.__alloyId4.add($.__views.contattiContainer);
    ...
    $.__views.__alloyId4.add($.__views.donaContainer);
